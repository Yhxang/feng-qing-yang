...
(function () {
    ...
    on: {
      ...
      slideChange: function (swiper) {
        ...
        if(pageHistory[pageHistory.length - 1] !== slideHistory){
          console.log('history: ', window.history, slideHistory);
  ...
  class PageRouter{
    constructor(){
      ...
      console.log('fffffffff',mainSwiper)
    }
    ...
    configRule(){
      ...
      this.pages.forEach(function(navPage, idx) {
        ...
        page(new RegExp("(en\\/)?" + navPage.navHref + "\\/?$"), function (ctx) {
          ...
          console.log('99999999',this)
          this.mainSwiper.slideTo(navPage.slideTargetIdx,0); 
