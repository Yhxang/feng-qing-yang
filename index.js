...
pages.forEach((page) => {
  base.get(`/${page}`, (req, res) => {
    console.log(`router: ${page}`);
    res.sendFile(path.resolve(__dirname, dist, 'cn', 'index.html'));
  });
});
base.get('/media/article/:page', (req, res) => {
  res.sendFile(path.resolve(__dirname, dist, 'cn', 'index.html'));
});
...
pages.forEach((page) => {
  baseEn.get(`/${page}`, (req, res) => {
    res.sendFile(path.resolve(__dirname, dist, 'en', 'index.html'));
  });
});
baseEn.get('/media/article/:page', (req, res) => {
  res.sendFile(path.resolve(__dirname, dist, 'en', 'index.html'));
});
...
//     next();
//   });
const gUrl = 'http://g-powertech.com.cn';
base.options('/api.php', cors(), (req, res) => {
  this.setResHeader(res);
  const redirectURL = gUrl + req.path;
